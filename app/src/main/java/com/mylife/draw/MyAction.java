...
// 点
class MyPoint extends MyAction {
    public float x;
    public float y;
...
// 圆框
class MyCircle extends MyAction {
    float startX;
    float startY;
    float stopX;
    float stopY;
...
// 方块
class MyFillRect extends MyAction {
    float startX;
    float startY;
    float stopX;
    float stopY;
...
// 圆饼
class MyFillCircle extends MyAction {
    float startX;
    float startY;
    float stopX;
    float stopY;
